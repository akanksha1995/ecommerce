          ...
          <div class="aa-header-top-area"> 
            ...
            <div class="aa-header-top-left"> 
              ...
              <div class="aa-currency">
                <div class="dropdown"> <a class="btn dropdown-toggle" href="#" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <i class="fa fa-usd"></i>CAD <span class="caret"></span> </a>
              ...
              <div class="cellphone hidden-xs">
                <p><span class="fa fa-phone"></span>+1 111-111-1111</p>
              </div>
              <!-- / cellphone --> 
            </div>
            <!-- / header top left -->
  ...
  <div class="aa-slider-area">
    <div id="sequence" class="seq">
      <ul class="seq-canvas">
        <!-- single slide item -->
        <li>
          <div class="seq-model"> <img data-seq src="img/slider/slider_1.png" alt="Men slide img" /> </div>
