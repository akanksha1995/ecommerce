          ...
          <div class="aa-header-top-area"> 
            ...
            <div class="aa-header-top-left"> 
              ...
              <div class="cellphone hidden-xs">
                <p><span class="fa fa-phone"></span>+1 111-111-111</p>
              </div>
              <!-- / cellphone --> 
            </div>
            <!-- / header top left -->
                        ...
                        <div class="panel-body">
                         <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                              	<input type="password" name="pass" required="required" min="6" placeholder="Password*">
                              </div>                             
                            </div>
                          </div>
                          <div class="row">
                          	<div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                 <input type="tel" name="contact" required="required" placeholder="Phone*">
                             </div>
                            </div>
                          </div>
                          <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                <input type="text"  name="city" required="required" placeholder="City / Town*">
                              </div>                             
                            </div>
                          </div> 
                          <div class="row">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                <textarea name="address" cols="20" rows="4" required="required" placeholder="Address*" ></textarea>
                              </div>                             
                            </div>
                          </div>   
